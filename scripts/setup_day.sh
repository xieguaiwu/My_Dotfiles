...
sudo dnf install -y ffmpeg ffmpeg-devel gstreamer1-plugins-base-devel gstreamer1-plugins-good \
gstreamer1-plugins-bad-free gstreamer1-plugins-ugly-free gstreamer1-plugins-bad-freeworld \
gstreamer1-plugins-ugly-freeworld gstreamer1-libav lame-devel x264-devel x265-devel libvpx-devel \
opus-devel alsa-lib-devel libsndfile-devel pulseaudio-libs-devel libv4l-devel
