...
\pagestyle{fancy}
\fancyhf{}
\rhead{AP Computer Science A Mock Examination}
\lhead{Page \thepage}
\cfoot{}
...
6. **答案分布**：避免答案过于规律
7. **Quick Reference**：只能使用 Quick Reference 中列出的方法
8. **避免 charAt**：`charAt()` 不在 Quick Reference 中，题目应使用 `substring(i, i+1)` 替代